export const es = {
  ...
  "auth/email-already-exists": {
    ...
    toClient:
      "Otro usuario ya está utilizando este correo electrónico, por favor escriba otro.",
  },
  ...
  "auth/invalid-credential": {
    ...
    toClient: "Usuarios o contraseña inválidos.",
  },
  ...
  "auth/invalid-display-name": {
    ...
    toClient:
      "El valor que se proporcionó para su nombre no es válido, por favor escriba un texto no vacío.",
  },
  ...
  "auth/invalid-email": {
    ...
    toClient:
      "El valor que se proporcionó para su correo electrónico no es válido, por favor escriba una dirección de correo válida.",
  },
  ...
  "auth/invalid-password": {
    ...
    toClient:
      "El valor que se proporcionó para la contraseña no es válido, por favor escriba un texto con al menos seis caracteres.",
  },
  ...
  "auth/invalid-phone-number": {
    ...
    toClient:
      "El valor que se proporcionó para el número de teléfono no es válido, por favor escriba un texto no vacío que cumpla con el estándar E.164.",
  },
  "auth/invalid-photo-url": {
    toDev:
      "El valor que se proporcionó para la propiedad del usuario photoURL no es válido. Debe ser una URL de string.",
    toClient:
      "El valor que se proporcionó para la URL de su foto de percil no es válido, por favor escriba una URL válida.",
  },
  ...
  "auth/phone-number-already-exists": {
    ...
    toClient:
      "Otro usuario ya está utilizando este número de teléfono, por favor escriba otro.",
  },
